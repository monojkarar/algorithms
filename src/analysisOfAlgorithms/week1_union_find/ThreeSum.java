 ...
 * <p>
 * The analysisOfAlgorithms.ThreeSum class provides methods for counting and
 * printing the number of triples in an array of distinct integer that sum to
...
public final class ThreeSum {
     ...
     * command-line argument; Counts the number of triples that sums to
     * exactly zero; prints out the time to perform the computation.
     *
