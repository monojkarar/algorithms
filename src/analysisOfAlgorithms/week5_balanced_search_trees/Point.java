...
/**
 *  Class Point is an immutable data type tat represents a point in the plane.
 *
...
public class Point implements Comparable<Point> {
    ...
    private final int y;
         ...
         *         is Double.NaN, Double.POSITIVE_INFINITY or Double
         *         .NEGATIVE_INFINITY
         */
     ...
     */
    private  double slopeTo(final Point that) {
