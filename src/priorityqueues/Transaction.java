...
public class Transaction implements Comparable<Transaction> {
    ...
    /**
     * Initializes a new transaction by parsing a string of the form NAME
     * DATE AMOUNT.
     *
    ...
    public static class WhoOrder implements Comparator<Transaction> {
        ...
        @Override
        /**
         * If v.who < w.who then return -1.0.
         * @return int -1.0 if v.who < w.who; false otherwise
         */
    ...
    public static class WhenOrder implements Comparator<Transaction> {
        ...
        @Override
        /**
         * If v.when < w.when then return -1.0.
         * @return int -1.0 if v.when < w.when; false otherwise
         */
        public int compare(final Transaction v, final Transaction w) {
    ...
    public static class HowMuchOrder implements Comparator<Transaction> {
        ...
        @Override
        /**
         * If v.amount < w.amount then return -1.0.
         * @return int -1.0 if v.amount < w.amount; false otherwise
         */
        public int compare(final Transaction v, final Transaction w) {
